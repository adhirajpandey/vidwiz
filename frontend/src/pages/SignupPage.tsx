...
export default function SignupPage() {
  ...
  return (
    <>
      <Seo
        title="Sign Up: Start with Smart Notes and Wiz | VidWiz"
        description="Create your VidWiz account to start capturing Smart Notes, chat with Wiz, and learn faster from YouTube videos."
        path="/signup"
      />
      <AuthLayout
